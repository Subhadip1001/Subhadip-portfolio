...
const Home = () => {
  ...
  return (
    <div ref={homeRef} name="Home" className='h-screen w-full bg-yellow-300 flex flex-col justify-center items-center text-center px-4 md:px-8 lg:px-16'>
      <h1 className='font-extrabold uppercase text-[50px] md:text-[70px] lg:text-[92px] leading-tight text-[#2A2A2A] relative' style={{ textShadow: '2px 0px 0px rgb(255, 255, 255)' }}>
        I'm Subhadip <br />
        Creative 
        {/* Capsule Wrapper */}
      ...
      className='px-3 py-1 md:px-4 md:py-2 lg:px-6 lg:py-3 bg-pink-400 rounded-full mt-6 md:mt-8 lg:mt-10 border-b-3 border-r-3 border-black cursor-pointer uppercase font-bold hover:border-b-6 hover:border-r-6 text-sm'>
        Download CV
      </a>
    </div>
  );
